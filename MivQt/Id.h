...
Q_DECLARE_METATYPE(MivQt::Id)
Q_DECLARE_METATYPE(QList<MivQt::Id>)

QT_BEGIN_NAMESPACE
QDataStream &operator<<(QDataStream &ds, MivQt::Id id);
QDataStream &operator>>(QDataStream &ds, MivQt::Id &id);
MIVQT_EXPORT QDebug operator<<(QDebug dbg, const MivQt::Id &id);
QT_END_NAMESPACE